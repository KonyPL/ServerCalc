    ...
    try:
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            while pwr:
                ...
                while True:
                    try:
                        val2 = int(input("Insert second value (max: 4 294 967 295): "))
                        if val1 > 4294967295:
                            raise OverflowError
                        break
                    except ValueError:
                ...
                while True:
                    calc = input("Do you want to make another calculation? (Yes/No) ")
        ...
        print("Error! Connection refused by server. It is very probable that the server isn't running.")
        while True:
